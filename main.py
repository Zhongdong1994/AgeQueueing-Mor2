...
def simulate():
    ...
    rounds = 30
    #modes=['FCFS']
    #modes = ['FCFS', 'RANDOM', 'LCFS', 'PS', 'PLCFS', 'SJF', 'PSJF', 'SRPT']   # For traditional policies
    #modes=['LCFS','SJF','ADM','ADS','ADF']  # For our proposed policies
    #modes = [ 'FCFS', 'RANDOM','LCFS', 'SJF', 'PSJF', 'SRPT','RANDOME', 'LCFSE', 'SJFE', 'PSJFE','SRPTE']  # For informative comparison
    modes = [ 'SJFE','PSJFE','SRPT', 'SRPTE', 'AoI2','AoI2PE']  # For the last comparison
